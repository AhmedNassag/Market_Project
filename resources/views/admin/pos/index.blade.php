            ...
            <div class="row mb-2">
                <div class="col">
                    <form class="d-flex">
                        ...
                        />
                        <button class="btn btn-sm rounded btn-success scan">بحث</button>
                    </form>
                </div>
            </div>
            <div class="user-cart">
        ...
        <div class="col-md-6 col-lg-8">
            ...
            <div class="order-product product-search" style="display: flex;column-gap: 0.5rem;flex-wrap: wrap;row-gap: .5rem;">
                @foreach($products as $product)
                    ...
                    >
                        @if($product->image)
                        <img src="{{ asset('storage/app/public/'.$product->image->id.'/'.$product->image->file_name) }}" width="45px" height="45px" alt="test" />
                        @endif
                    ...
                    success: function(response) {
                        ...
                        $.each(response, function(key,product) {
                            ...
                            <button type="button"
                                ...
                                value="${product.id}"
                            >
                                <img src="http://127.0.0.1:8000/storage/app/public/${product.image.id}/${product.image.file_name}" width="45px" height="45px" alt="test" />
